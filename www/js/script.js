...
function eqHeight(colsInRow, path){
  path = path || ".catalog .cat-products .prod-description";
  var cols = $(path);
  var colsArr = [];
  var colHeight = [];
  cols.each(function(){
...
if (window.matchMedia('(min-width: 768px)').matches){
  ...
  var fade;
  $(".head-3 .container .navbar-nav").mouseenter(function(){
    $(".h3-dropdown-menu").slideDown(150);
    }).mouseleave(function(e){
      $(".h3-dropdown-menu").slideUp(150);
    });
...
eqHeight(5, ".cart-cont .cat-products .prod-description");
